...
<details>
	...
	<ul style="list-style:none">
		...
		<li>
			<p>📱La Haus Brokers</p>
			<p>Project developed at Holberton School Colombia with the mentoring and supervision of La Haus</p>
			...
			<a href="https://www.youtube.com/watch?v=x-9OQeZsKtI&feature=youtu.be">▶️ Demo</a><br/>
			...
			<ul>
				...
				<li>
					<p><b>Design Pattern:</b> based on the model view controller, Bloc is the pattern recommended by Google</p>
				</li>
			</ul>
		</li>
		<li>
